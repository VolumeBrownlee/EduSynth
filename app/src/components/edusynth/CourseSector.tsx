        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {isLecturer && (
            <Button
              ...
              className="shrink-0 bg-[#2DD4BF]/10 text-[#2DD4BF] hover:bg-[#2DD4BF]/20 border border-[#2DD4BF]/20 gap-1.5 text-xs h-9"
            >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 rounded-xl glass border border-border bg-transparent text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-[#2DD4BF]/30 focus:ring-1 focus:ring-[#2DD4BF]/20"
            />
          </div>
        ...
        {filteredClassrooms.map((classroom, classIdx) => {
          ...
          return (
            <motion.div key={classroom.id} variants={itemVariants}>
              <Card
                className="glass border-border hover:border-[#2DD4BF]/20 hover:shadow-lg hover:shadow-[#2DD4BF]/5 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer group overflow-hidden"
              ...
              >
                <div
                  className={`h-1 ${
                    classAvg >= 70
                      ? 'bg-gradient-to-r from-[#2DD4BF] to-[#06B6D4]'
                      : classAvg >= 40
                      ? 'bg-[#F59E0B]'
                      : 'bg-zinc-700'
                  }`}
          ...
          return (
            ...
            >
              ...
              <circle
                ...
                cy={y}
                r={nodeRadius}
                fill={isCompleted ? '#2DD4BF' : isInProgress ? '#F59E0B' : isLocked ? '#27272A' : '#1C1C1E'}
                stroke={
                  isCompleted ? '#5EEAD4' : isInProgress ? '#FBBF24' : isLocked ? '#3F3F46' : '#52525B'
                }
              ...
              {score > 0 && !isLocked && (
                <>
                  ...
                  <text
                    ...
                    y={y + nodeRadius + 15}
                    textAnchor="middle"
                    fill={isCompleted ? '#2DD4BF' : '#F59E0B'}
                    fontSize={9}
                    fontWeight="bold"
                    fontFamily="system-ui"
                  >
